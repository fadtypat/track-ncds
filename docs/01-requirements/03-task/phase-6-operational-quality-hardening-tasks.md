...
**หมายเหตุอัปเดต 2026-09-24 (รอบสอง):** ไม่มีรหัสใหม่เพิ่มใน Phase นี้ แต่ขอบเขตการทดสอบของ T-6-05
(NFR-14) ขยายให้ครอบคลุมกฎสิทธิ์ใหม่ที่เกิดจาก FR-11–FR-15/NFR-19/NFR-20 ที่เพิ่มเข้า
[[phase-1-authentication-tasks|Phase 1]] และ [[phase-4-complication-risk-analysis-alerting-tasks|Phase 4]]
ด้วย
...
| T-6-05 | ทดสอบอัตโนมัติครอบคลุมทุกกรณีสิทธิ์การเข้าถึงข้อมูล (ผู้ป่วยในความดูแล/นอกความดูแล, บทบาทต่างๆ, บัญชียังไม่ยืนยันอีเมล, **สิทธิ์ Admin เข้าถึงผู้ป่วยทุกรายโดยไม่มี PatientAssignment เป็นของตนเอง (NFR-19), การเขียน/อ่าน PatientAssignment ผ่านการจัดการของ Admin (FR-14), บัญชีที่ถูกระงับใช้งาน (FR-13)** ฯลฯ) ก่อนใช้งานกับข้อมูลผู้ป่วยจริงทุกครั้ง | NFR-14 | อาศัยกลไกควบคุมสิทธิ์จาก [[phase-2-patient-search-selection-data-protection-foundation-tasks|Phase 2]], [[phase-1-authentication-tasks|Phase 1]] (รวม FR-11–14 ที่เพิ่มเข้ามา 2026-09-24 รอบสอง) และ [[phase-4-complication-risk-analysis-alerting-tasks|Phase 4]] (FR-15/NFR-19/NFR-20) ครบแล้ว |
